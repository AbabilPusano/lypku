    ...
    <div class="flex">
        ...
        <div class="flex flex-col w-full">
            ...
            <section id="dashboard"
                class="min-h-screen font-poppins w-full flex flex-col mt-4 pt-10 px-4 pb-20 bg-gray-100">
                <div class="flex flex-col bg-white p-4 w-full rounded-lg">
                    <div class="flex justify-between">
                        ...
                        <button type="submit" class="bg-[#D91656] hover:bg-[#C30054] text-white px-3 py-1 rounded-md"
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex justify-between p-4 border-2 rounded-lg">
                            <div class="flex flex-col">
                                <div class="flex items-center gap-4">
                                    <div>Rumah</div>
                                    <div class="p-1 border-2 text-sm text-[#D91656] border-[#D91656]">Utama</div>
                                </div>
                                <div class="flex">
                                    <div>Ahmad Hasan</div>
                            ...
                            <div class="flex flex-col gap-2 items-end">
                                <a href="" class="text-[#D91656]">Ubah</a>
                        ...
                        <div class="flex justify-between p-4 border-2 rounded-lg">
                            ...
                            <div class="flex flex-col gap-2 items-end">
                                <a href="" class="text-[#D91656]">Ubah</a>
                                <button class="p-2 border-2 rounded-lg bg-[#D91656] hover:bg-[#C30054] text-white">Atur sebagai Utama</button>
                            </div>
                        </div>
                    </div>
                </div>
