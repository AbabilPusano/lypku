...
<header class="shadow fixed top-0 w-full z-10 h-20 bg-white">
    ...
    <section id="belanja" class="px-4 lg:px-40 py-40 bg-[#FBF6F0]">
        ...
        <div class="container mx-auto text-center">
            <h2 class="text-xl lg:text-4xl text-left font-poppins font-bold mb-8 text-black tracking-wide">
                <span class="text-[#D91656]">Memori</span> Peliharaanku</h2>
                    ...
                    <dialog id="modal_tambah" class="modal backdrop-blur-lg">
                        <div class="modal-box font-poppins p-0 w-76 lg:w-96 flex flex-col">
                            <div class="flex items-center bg-[#047D00] rounded-t-lg h-24 lg:h-40">
                                <h2 class="text-xl lg:text-2xl font-bold text-center text-white w-full m-4">Tambah Memori</h2>
                            </div>
                            <div class="px-8 pt-4 pb-12">
                                <form id="formTambahMemori" enctype="multipart/form-data" class="flex flex-col gap-2">
                                    @csrf
                                    <div class="flex flex-col">
                                        <label for="judul">Judul</label>
                                        <input type="text" id="judul" name="judul" placeholder="Masukkan judul memori"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi memori"
                                            class="w-full p-2 rounded-md bg-gray-100 focus:outline-none focus:ring focus:ring-[#047D00] focus-border-[#047D00]" required></textarea>
                                    </div>
                                    <div class="flex flex-col">
                                        <label for="hewans">Hewan yang Terlibat</label>
                                        <select id="hewans" name="hewans[]" multiple
                                            class="w-full p-2 rounded-md bg-gray-100 focus:outline-none focus:ring focus:ring-[#047D00] focus-border-[#047D00]" required>
                                    ...
                                    <div class="flex flex-col">
                                        <label for="photos">Foto Memori</label>
            ...
            <!-- Card -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:justify-center mt-10">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const formTambahMemori = document.getElementById("formTambahMemori");
            const loadingTambah = document.getElementById("loadingTambah");
            const modalTambah = document.getElementById("modal_tambah");

            formTambahMemori.addEventListener("submit", async function (event) {
                ...
                const formData = new FormData(formTambahMemori);
                ...
                try {
                    ...
                    if (response.ok) {
                        // Jika sukses
                        alert("Memori berhasil ditambahkan!");
                        loadingTambah.style.display = "none";
                        modalTambah.close();
                        location.reload(); // Refresh halaman
                    } else {
                        // Jika gagal
                        alert(result.message || "Terjadi kesalahan saat menambahkan memori.");
                        loadingTambah.style.display = "none";
                    }
                } catch (error) {
                    console.error("Error:", error);
